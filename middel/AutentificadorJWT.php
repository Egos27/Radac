...
class AutentificadorJWT
{
    ...
    public static function CrearToken($request, $response, $args)
    {
        $miUsuario=$request->getParsedBody()["Usuario"];
        //var_dump($miUsuario);
        $datos=Usuario::validarUsuario($miUsuario["usuario"], $miUsuario['password']);
        if(!$datos)
            return "";
        $ahora = time();
